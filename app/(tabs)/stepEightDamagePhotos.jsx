...
const StepEightDamagePhotos = ({ onBack, containerData, onNavigateToStepNine, onNavigateToInspectionRemarks, onNavigateToStepNineDirect }) => {
    ...
    // Camera overlay dimensions (matching Front Wall horizontal frame)
    const screenWidth = Dimensions.get('window').width;
    const screenHeight = Dimensions.get('window').height;
    const damageFrameWidth = screenWidth * 0.85; // Same as Front Wall
    const damageFrameHeight = damageFrameWidth * 0.94; // Same as Front Wall
    const centerX = (screenWidth - damageFrameWidth) / 2;
    const centerY = (screenHeight - damageFrameHeight) / 2 - 80; // Same as Front Wall
    ...
    const cropImageToDamageFrame = async (imageUri) => {
        try {
            ...
            if (cropArea.x + cropArea.width > imageInfo.width || cropArea.y + cropArea.height > imageInfo.height) {
...
export default StepEightDamagePhotos;
