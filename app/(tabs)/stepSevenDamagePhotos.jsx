        ...
        try {
            ...
            if (photo?.uri) {
                try {
                    ...
                    console.log(`📊 Original Left Wall damage photo size: ${(blob.size / 1024).toFixed(2)} KB`);
                } catch (e) {}
                ...
                try {
                    ...
                    console.log(`📊 Cropped Left Wall damage photo size: ${(blob.size / 1024).toFixed(2)} KB`);
                ...
                console.log('📸 Left Wall damage photo taken and cropped successfully');
                setShowCamera(false);
            }
        } catch (error) {
